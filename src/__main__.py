...
import argparse
from src.llm import select_function, build_selection_prompt, build_parameter_prompt, select_parameters_num, select_parameters
...
def main() -> None:        
    ...
    params = select_parameters(model, fun[0], prompt) #TODO do przetestowania !!!
    print("sdsdff ", params)
